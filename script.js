// 1. 單字資料庫 (包含所有單字)
const wordBank = [
  { eng: "generate", ch: "產生(v.)" },
    { eng: "script", ch: "劇本、腳本(n.)" },
    { eng: "ineligible", ch: "不符合資格的(adj.) +for" },
    { eng: "screenplay", ch: "電影劇本(n.)" },
    { eng: "postproduction", ch: "後期製作(n.)" },
    { eng: "prevent", ch: "預防(v.) +from" },
    ...
    { eng: "visibility", ch: "可見度(n.)" },
    { eng: "preference", ch: "偏好(的人事物)(n.)" },
    { eng: "particularly", ch: "尤其是(adv.)" },
    { eng: "rise", ch: "上升(vi.)；興起(n.)" },
    { eng: "among", ch: "在...之間 (三者以上)" },
    { eng: "remain", ch: "維持(v.)" },
    { eng: "expect", ch: "預期(v.)" },
    { eng: "be famous for", ch: "以...(原因)聞名" },
    { eng: "be famous as", ch: "以…(身分)聞名" },
    { eng: "apart", ch: "相隔、分開(adv.)" },
    { eng: "argument", ch: "爭吵、論點(n.)" },
    { eng: "immediately", ch: "立刻(adv.)" },
    { eng: "would rather...than...", ch: "寧願...勝過...(若放動詞需用原V)" },
    { eng: "from now on", ch: "從現在開始" },
    { eng: "symbol", ch: "象徵、符號(n.)" },
      { eng: "suggest", ch: "建議(v.)" },
      { eng: "force", ch: "強迫(v.) +to" },
      { eng: "describe", ch: "描述(v.)" },
      { eng: "strip", ch: "條、連載漫畫(n.)；剝去、脫衣(v.)" },
      { eng: "in that spirit", ch: "秉持那樣的精神" },
      { eng: "publish", ch: "出版(v.)" },
      { eng: "ridiculous", ch: "荒謬的(adj.)" },
      { eng: "suit", ch: "適合(v.)；訴訟、西裝(n.)" },
      { eng: "fit", ch: "適合(v.)；適合的東西(n.)" },
      { eng: "inspire", ch: "啟發(v.)" },
      { eng: "charity", ch: "慈善活動(n.)" },
      { eng: "project", ch: "計畫(n.)" },
      { eng: "organization", ch: "組織(n.)" },
      { eng: "encourage", ch: "鼓勵(v.)" },
      { eng: "contact", ch: "接觸、聯繫(v.)" },
      { eng: "career", ch: "職業生涯(n.)" },
      { eng: "dedication", ch: "奉獻(n.)" },
      { eng: "nervous", ch: "緊張的(adj.)" },
      { eng: "though", ch: "不過(句尾)、雖然" },
      { eng: "get the hang of...", ch: "漸漸掌握...的竅門" },
      { eng: "incredible", ch: "不可置信的(adj.)" },
...
const GOOGLE_APP_URL = "https://script.google.com/macros/s/AKfycbzkpmRwHJzp_vByBST5yPs-EItL9sABYTYvuCdHo3sytMHeMmrOQgSECTQDl8geOmS6Jw/exec";
